...
function App() {
  ...
  const handleNavigateToPlan = (category: string | null) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-[#F8FAFC]">
      ...
      {view === 'student-dash'     && <StudentDashboard userName={userName} onLogout={handleLogout} onNavigateToPlan={handleNavigateToPlan} />}
      {view === 'study-plan'       && <StudyPlanPage userName={userName} category={studyCategory} onBack={() => setView('student-dash')} />}
